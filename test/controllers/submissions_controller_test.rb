...
class SubmissionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create submission" do
    assert_difference('Submission.count') do
      post submissions_url, params: { submission: { article_id: @submission.article_id, journal_id: @submission.journal_id } }
    end
  ...
  test "should update submission" do
    patch submission_url(@submission), params: { submission: { article_id: @submission.article_id, journal_id: @submission.journal_id } }
